...
/**
 * A method that is used to match tokens when defining a token. This is meant to be used as a lambda to make writing new custom methods for matching extremely simple. It also
 * allows for much more flexibility when manipulating the methods, their inputs and outputs, and a plethora of other stuff.
 *
